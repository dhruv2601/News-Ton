...
public class RssAdapterSaved extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String articleLink = RssAdapterSaved.items.get(position).getLink();
        ...
        shareimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String articleLink = RssAdapterSaved.items.get(position).getLink();    // yahan 3 ki jgah RssService ki list view mn jo bhi position p ye send vala btn hoga vo aayega
                shareIntent.putExtra(Intent.EXTRA_TEXT, items.get(position).getTitle() + "\n" + articleLink);
        ...
        fullart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alert.setTitle(RssAdapterSaved.items.get(position).getTitle());

                wv = new WebView(RssAdapterSaved.context);
...
//                context.startActivity(i);
        ...
        listenimg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MainActivity.t1.speak(RssAdapterSaved.items.get(position).getTitle().toString(), TextToSpeech.QUEUE_FLUSH, null);
            }
        });
...
//        ----->>>>>    CAUTION  ::::::   DO NOT DELETE    <<<<<-------         //
        ...
        Picasso.with(RssAdapterSaved.this.context).load(items.get(position).getThumbnail()).into(holder.rand);
        return convertView;
    }
...
//        dialog.setContentView(R.layout.expand_image);
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(RssAdapterSaved.context, R.style.MyDialogTheme);
        alert.setTitle("Image");

        ImageView img = new ImageView(RssAdapter.context);
        alert.setView(img);

        Picasso.with(RssAdapterSaved.this.context).load(items.get(globalPos).getThumbnail()).into(img);
...
//                                File file = new File(new File("/sdcard/NewsFeed/"), direct.toString()+System.currentTimeMillis()%10000+".jpg");
                ...
                Picasso.with(RssAdapterSaved.this.context).load(
