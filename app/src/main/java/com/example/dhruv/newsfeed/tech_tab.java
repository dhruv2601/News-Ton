...
/**
 * Created by dhruv on 31/8/16.
 */
public class tech_tab extends Fragment implements java.io.Serializable{
    Uri uri;
...
//    }
    ...
    private void addRssFragment() {
        ...
        if (b == false) {
            ...
            transaction.add(R.id.techContainer, fragment);
            transaction.commit();
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            Log.d(TAG, "techViewIsNull");
            view = inflater.inflate(R.layout.tab_tech, container, false);
        } else {
            Log.d(TAG, "techViewIsNotNull");
            ViewGroup parent = (ViewGroup) view.getParent();
            parent.removeView(view);
        }

//        view = inflater.inflate(R.layout.tab_sports, container, false);
//        Log.d(TAG, "sports_Tab " + view);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        getActivity().setContentView(R.layout.tab_tech);

        Log.d(TAG, "techTabOnCreate");

        if (getActivity().findViewById(R.id.techContainer) != null) {

            if (savedInstanceState == null) {
                Log.d(TAG, "beforeCallingARFtech");
//                addRssFragment();                            // onCreateView is not being called, tried removing this fn call but to no effect and b/c oCV not called View set nhi ho pa rha hai
        ...
        MainActivity.position = 2;    // for topStories
