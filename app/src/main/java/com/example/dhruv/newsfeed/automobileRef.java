...
public class automobileRef extends Fragment {
    public View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.automobile, container, false);
        ...
        rlWithTop = (RelativeLayout) view.findViewById(R.id.rlWithAuto);
        ...
        ndtvS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                url = "http://timesofindia.indiatimes.com/zigwheels.cms";
        ...
        tensports.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                url = "http://automobiles.mapsofindia.com/";
