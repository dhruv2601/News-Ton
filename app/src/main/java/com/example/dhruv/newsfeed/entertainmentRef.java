...
public class entertainmentRef extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.entertainment,container,false);
        ...
        rlWithTop = (RelativeLayout) view.findViewById(R.id.rlWithEnter);
        ...
        espn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                url = "http://www.dnaindia.com/entertainment";
        ...
        neo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                url = "http://www.hindustantimes.com/entertainment/";
        ...
        tensports.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                url = "http://www.latimes.com/entertainment/";
        ...
        crick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                url = "http://www.telegraph.co.uk/news/entertainment/";
