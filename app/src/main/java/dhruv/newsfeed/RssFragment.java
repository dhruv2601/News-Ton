...
import static dhruv.newsfeed.RssAdapter.context;
import static dhruv.newsfeed.RssAdapter.wv;
...
//            avi2.hide();
            ...
            if (items != null) {
                ...
                SharedPreferences timeBomb;
                timeBomb = getContext().getSharedPreferences("timeBomb",0);
                SharedPreferences.Editor timeEditor = timeBomb.edit();
                if(System.currentTimeMillis()-timeBomb.getLong("timeEpoch",0)>21600000)      // add 10 ki power 5
                {
                    editor.clear();
                    editor.commit();
                    ...
                    timeEditor.putLong("timeEpoch", System.currentTimeMillis());
                    timeEditor.commit();
                }
